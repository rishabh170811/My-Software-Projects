...
<script type="text/javascript">
    ...
    var sdatearray=b.split("-");
    var edatearray=c.split("-");

    var d=new Date();
    var date=d.getDate();

    if((edatearray[2]<=sdatearray[2]) || (sdatearray[2]<date) || (edatearray[2]<=date))
    {
...
<div id="menu">
	<ul>
		<li><a href="index_author.php">Home</a></li>
...
<form name="courses" method="post" action="insertcourse.php?role=2" enctype="multipart/form-data" >
