...
if($dn1['nb1']>0)
{
if($_SESSION['userid']==$dn1['authorid'] or $_SESSION['usernamef']==$admin)
{
...
if(isset($_POST['message']) and $_POST['message']!='')
{
	if($id2==1)
	{
		if($_SESSION['usernamef']==$admin and isset($_POST['title']) and $_POST['title']!='')
		{
			$title = $_POST['title'];
...
<?php
if($_SESSION['usernamef']==$admin and $id2==1)
{
?>
