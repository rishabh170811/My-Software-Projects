...
echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> List of Authors!</td> </tr> </table> </div>";
...
<td align='left'> <input type='button' name='block' value='Delete' style='color:blue;font-weight:bold' onclick=window.location='delete.php?id=" . $i . "&role=2'></td>
</tr>
</table></div>";
