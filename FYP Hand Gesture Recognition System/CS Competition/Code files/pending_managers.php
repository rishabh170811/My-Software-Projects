...
$query = mysql_query("SELECT * FROM Pending_managers");

echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> List of pending Content Managers!</td> </tr> </table> </div>";
...
<td align='left'> <input type='button' name='approveb' value='Approve' style='color:blue;font-weight:bold' onclick=window.location='approve.php?id=". $i . "&role=3'></td>
<td align='left'> <input type='button' name='rejectb' value='Reject' style='color:blue;font-weight:bold' onclick=window.location='reject.php?id=". $i . "&role=3'></td>
</tr>
</table></div>";
}
