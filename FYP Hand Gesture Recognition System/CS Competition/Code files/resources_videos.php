...
if($cnt!=0)
	echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> The following lecture videos are available!</td> </tr> </table> </div>";
else
	echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> No Lecture videos found</td> </tr> </table> </div>";
...
<td align='left'> <a href='view_videos.php?id=" . $i . "' style='color:black;' target='_blank'> View </td>
<td align='left'> <input type='button' name='delete' value='Delete' style='color:blue;font-weight:bold' onclick=window.location='delete_resources.php?id=" . $i . "&type=4'></td>
</tr>
</table></div>";
