...
{
	unset($_SESSION['usernamef'], $_SESSION['userid']);
...
<div class="message">You have successfully logged out.<br />
<a href="<?php echo $url_home; ?>">Home</a>&nbsp;|&nbsp;
<a href="../index_student.php">Go out of Forum</a></div></div>
<?php
}
else
{
...
<a href="<?php echo $url_home; ?>">Welcome</a></div>
<?php
		}
		else
		{
