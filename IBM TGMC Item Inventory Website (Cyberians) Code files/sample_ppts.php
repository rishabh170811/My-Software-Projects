...
$status=1;
$query = mysql_query("SELECT * FROM Slides WHERE Status='$status'");

echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> The following are sample Lecture slides!</td> </tr> </table> </div>";
