...
<td align='left'> <input type='button' name='delete' value='Delete' style='color:blue;font-weight:bold' onclick=window.location='delete_courses.php?name=" . $name . "&type=2'></td>
<td align='left'> <input type='button' name='test' value='Make Test' style='color:blue;font-weight:bold' onclick=window.location='course_test.php?name=" . $name . "'></td>
</tr>
</table></div>";
