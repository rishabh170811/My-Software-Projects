...
xmlhttp.open("GET","getresource.php?q="+str+"&type=4",true);
xmlhttp.send();
}
...
if($cnt==0)
	echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> No lecture videos available!</td> </tr> </table> </div>";
else
	echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> The following videos are available for download!</td> </tr> </table> </div>";
...
<td align='left'> <a  href='view_videos.php?id=" . $i . "' target='_blank' style='color:black'>View Video</td>
<td align='left'> <a  href='view_resources.php?id=" . $i . "&type=4' target='_blank' style='color:black'>View Video Desc.</td>
<td align='left'> <input type='button' name='download' value='Download' style='color:blue;font-weight:bold' onclick=window.location='download_videos.php?id=" . $i . "'></td>
<td align='left'> <input type='button' name='bmark' value='Bookmark' style='color:blue;font-weight:bold' onclick=window.location='bookmarks.php?name=" . $file_name . "&type=4&id=" . $i . "'></td>
</tr>
</table></div>";
}
