...
xmlhttp.open("GET","getresource.php?q="+str+"&type=2",true);
xmlhttp.send();
}
...
<td align='left'> <input type='button' name='download' value='Download' style='color:blue;font-weight:bold' onclick=window.location='download_ppt.php?id=". $i . "'></td>
<td align='left'> <input type='button' name='bmark' value='Bookmark' style='color:blue;font-weight:bold' onclick=window.location='bookmarks.php?name=" . $file_name . "&type=3&id=" . $i . "'></td>
</tr>
</table></div>";
