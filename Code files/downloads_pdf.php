...
xmlhttp.open("GET","getresource.php?q="+str+"&type=1",true);
xmlhttp.send();
}
...
<td align='left'> <a  href='view_resources.php?id=" . $i . "&type=1' target='_blank' style='color:black'>View </td>
<td align='left'> <input type='button' name='download' value='Download' style='color:blue;font-weight:bold' onclick=window.location='download_pdf.php?id=". $i. "'></td>
<td align='left'> <input type='button' name='bmark' value='Bookmark' style='color:blue;font-weight:bold' onclick=window.location='bookmarks.php?name=" . $file_name . "&type=1&id=" . $i . "'></td>
</tr>
</table></div>";
