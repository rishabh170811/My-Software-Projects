...
if($cnt!=0)
	echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> No E Books available!</td> </tr> </table> </div>";
else
	echo "<div class='CSS_Table_Example' style='width:800px;height:50px'> <table name='header'> <tr> <td> The following E books are available for download!</td> </tr> </table> </div>";
...
<td align='left'> <input type='button' name='delete' value='Delete' style='color:blue;font-weight:bold' onclick=window.location='delete_resources.php?id=" . $i . "&type=1'></td>
</tr>
</table></div>";
...
if($status==0)
	echo "<td align='left'> <input type='button' name='favorite' value='Favorite' style='color:blue;font-weight:bold' onclick=window.location='favorite.php?id=" . $i . "&type=1'></td>";
else
	echo "<td align='left'> <input type='button' name='unfavorite' value='Unfavorite' style='color:blue;font-weight:bold' onclick=window.location='unfavorite.php?id=" . $i . "&type=1'></td>"; 
